...
let playerPosition = { x: 170, y: 150 };
...
const walls = [
    ...
    // Existing internal walls with new modifications
    ...
    // New added complexity with diagonal and zigzag walls
    { x: 150, y: 50, width: 50, height: 10 },    // Small horizontal wall
    { x: 150, y: 50, width: 10, height: 50 },    // Small vertical wall
    ...
    // New additions for higher complexity
    { x: 50, y: 350, width: 50, height: 10 },   // Bottom left horizontal wall
    { x: 50, y: 300, width: 10, height: 50 },   // Bottom left vertical wall

    { x: 275, y: 150, width: 10, height: 75 },  // Additional vertical wall in the middle
    { x: 275, y: 150, width: 75, height: 10 },  // Upper middle horizontal wall

    { x: 150, y: 150, width: 50, height: 10, rotation: 45 },   // Additional diagonal wall near the center
    { x: 200, y: 200, width: 50, height: 10, rotation: -45 },  // Another diagonal crossing wall

    // Zigzag walls for extra complexity
    { x: 50, y: 150, width: 50, height: 10 },   // Start of zigzag
    { x: 100, y: 150, width: 10, height: 50 },  // Zigzag vertical
    { x: 100, y: 200, width: 50, height: 10 },  // Zigzag horizontal
    
    { x: 300, y: 50, width: 10, height: 75 },   // Another vertical blocking wall
    { x: 325, y: 125, width: 50, height: 10 },  // Horizontal wall near the right side
    { x: 350, y: 200, width: 10, height: 100 }, // New right-side vertical wall
    
    // Small gaps to create narrow passages
    { x: 150, y: 300, width: 10, height: 50 },  // Narrow vertical passage
    { x: 250, y: 300, width: 10, height: 50 },  // Another narrow passage
];
